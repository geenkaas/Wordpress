...
<head>
  ...
  <meta name="viewport" content="width=device-width">
	...
	<link rel="shortcut icon" href="<?php bloginfo("template_url");?>/images/touch/apple-touch-icon.png" />

	<!-- Stylesheets -->
		<link rel="stylesheet" href="<?php bloginfo("stylesheet_url");?>" />
		
	<!-- Bringing old browsers up to date -->
		<script src="<?php bloginfo("template_url");?>/scripts/libs/modernizr-2.6.1.min.js"></script>
